...
async def recommend_image(request: Request, image: UploadFile = File(...)) -> JSONResponse:
    """
    ...
    try:
        result = request.app.state.recommend_service.recommend_from_bytes(image_bytes, suffix)
